...
Norman introduces the seven stages of action, a crucial framework for analyzing user interaction. This cycle explains the mental and physical processes involved in achieving a goal.  Understanding these stages is paramount to designing effective systems.
...
Bridging these gulfs is crucial for good design.  It involves creating clear mappings between intentions and actions (execution) and providing clear and understandable feedback (evaluation).
...
Norman consistently advocates for a human-centered design approach.  This means starting with a deep understanding of the user's needs, goals, and limitations.  It involves:
