...
* **Managing Your "Self-Talk":**  Challenging your negative self-talk and replacing it with more constructive narratives.  This crucial step allows you to approach the conversation with greater calm and control.
...
* **Separating Actions from Identity:**  Remember that actions are not the same as inherent character. Mistakes don't invalidate our overall worth.
...
This step is crucial to move past defensiveness and towards a collaborative resolution.
...
* **Acknowledging Shared Responsibility:**  Recognize that both parties often contribute to the difficulty.
